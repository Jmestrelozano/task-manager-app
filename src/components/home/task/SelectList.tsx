...
export const SelectList: FC<ISelectList> = ({ lists, selected, setSelected, label, register }) => {
  return (
    <div className="w-full">
      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <Listbox.Button
            {...register} // Aplica el register aquí
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="border z-50 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
